        ...
        <div className=" flex-1 flex flex-col items-center gap-4 lg:grid lg:grid-cols-2 xl:grid-cols-5  pt-8">
          ...
          <div className=" xl:col-span-3 w-full h-full flex flex-col justify-evenly gap-4">
            ...
            >
              ...
              <p>
                {language === "es"
                  ? "Tengo una sólida base en tecnologías como React, Next.js, Angular, y he trabajado tanto con JavaScript como con TypeScript. Mi destreza en CSS y frameworks como Tailwind me permiten diseñar interfaces atractivas y altamente responsivas. Soy un comunicador efectivo, trabajador en equipo y me adapto rápidamente a nuevas tecnologías."
                  : "I have a solid foundation in technologies such as React, Next.js, Angular, and have worked with both JavaScript and TypeScript. My skills in CSS and frameworks such as Tailwind allow me to design attractive and highly responsive interfaces. I am an effective communicator, team player and I quickly adapt to new technologies."}
              </p>
              <br />
              <p>
                {language === "es"
